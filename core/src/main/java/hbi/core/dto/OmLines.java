...
/**
 * 封装了bill、itemDescription、itemUom、itemCode的订单行
 **/
...
public class OmLines extends BaseDTO {
    ...
    public static final String FIELD_ORDER_QUANTITY_UOM = "orderQuantityUom";//冗余字段
